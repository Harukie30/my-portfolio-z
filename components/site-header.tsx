...
export function SiteHeader() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex h-14 items-center justify-between gap-3 rounded-2xl border border-border/70 bg-background/80 px-3.5 shadow-[0_1px_0_0_oklch(0_0_0/0.04)_inset,0_10px_30px_-18px_oklch(0.2_0_0/0.45)] backdrop-blur-xl",
      ...
      >
        ...
        >
          <span
            className="size-2.5 rounded-full bg-linear-to-br from-blue-600 to-sky-400 shadow-[0_0_14px_oklch(0.55_0.18_252/0.55)] transition-transform duration-200 group-hover:scale-110"
            aria-hidden
          />
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button
                variant="ghost"
                size="icon-sm"
                className="shrink-0 rounded-full border border-border/70 bg-background/70"
